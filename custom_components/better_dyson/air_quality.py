...
class DysonAirSensor(AirQualityEntity):
    ...
    async def async_added_to_hass(self):
        ...
        self.hass.async_add_executor_job(self._device.add_disconnect_listener, self.on_device_disconnect)

    def on_message(self, message):
        """Handle new messages which are received from the fan."""
        from libdyson.dyson_pure_state_v2 import DysonEnvironmentalSensorV2State
