...
class DysonPureCoolLinkDevice(FanEntity):
    ...
    def on_message(self, message):
        ...
        from libdyson.dyson_pure_state import DysonPureCoolState
    ...
    def set_speed(self, speed: str) -> None:
        ...
        from libdyson.const import FanSpeed, FanMode
    ...
    def turn_off(self, **kwargs) -> None:
        """Turn off the fan."""
        from libdyson.const import FanMode
    ...
    def oscillate(self, oscillating: bool) -> None:
        ...
        from libdyson.const import Oscillation
    ...
    def speed(self) -> str:
        ...
        from libdyson.const import FanSpeed
    ...
    def set_night_mode(self, night_mode: bool) -> None:
        ...
        from libdyson.const import NightMode
...
class DysonPureCoolDevice(FanEntity):
    ...
    def on_message(self, message):
        """Call when new messages received from the fan."""
        from libdyson.dyson_pure_state_v2 import DysonPureCoolV2State
