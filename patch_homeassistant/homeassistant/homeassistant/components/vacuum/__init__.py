...
class _BaseVacuum(Entity):
    ...
    _attr_available_rooms: list[Any]
    _attr_active_rooms: list[Any]
    ...
    @property
    def available_rooms(self) -> list[Any]:
        """Get the list of available rooms for vacuum room cleaning."""
        return self._attr_available_rooms

    @property
    def active_rooms(self) -> list[Any]:
        """Get the list of available rooms for vacuum room cleaning."""
        return self._attr_active_rooms
    ...
    def capability_attributes(self) -> Mapping[str, Any] | None:
        ...
        if self.available_rooms is not None:
            attributes[ATTR_AVAILABLE_ROOMS] = self.available_rooms
    ...
    def state_attributes(self) -> dict[str, Any]:
        ...
        if self.supported_features & VacuumEntityFeature.ROOMS:
...
class StateVacuumEntity(_BaseVacuum):
    ...
    @property
    def support_rooms(self):
        """Boolean if cleaning rooms is supported."""
        return bool(self.supported_features & VacuumEntityFeature.ROOMS)
